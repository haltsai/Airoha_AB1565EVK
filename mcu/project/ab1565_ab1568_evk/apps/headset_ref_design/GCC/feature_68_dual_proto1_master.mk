...
IC_TYPE                               = ab1568
BOARD_TYPE                            = ab1568_dual_chip_proto1
BL_FEATURE                            = feature_68_evb.mk
PRODUCT_CATEGORY                      = AB1568_dual_chip
...
#Because dual chip master don't need support ULL and common BT profile in the same project.
AIR_ONLY_DONGLE_MODE_ENABLE = y
...
#In dual chip mixing project, this chip is master
...
# Audio Output Mixer Gain
AIR_AUDIO_MIXER_GAIN_ENABLE = n
