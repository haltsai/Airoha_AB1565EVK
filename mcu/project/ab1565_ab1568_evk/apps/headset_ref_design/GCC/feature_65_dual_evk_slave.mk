...
PRODUCT_CATEGORY                      = AB1565_dual_chip
...
#In dual chip mixing project, this chip is slave
AIR_DUAL_CHIP_MIXING_MODE_ROLE_SLAVE_ENABLE = y

#Enable Source HWSRC RX Tracking mode
AIR_HWSRC_RX_TRACKING_ENABLE = y

#Enable Sink HWSRC TX Tracking mode
AIR_HWSRC_TX_TRACKING_ENABLE = y

#Enable DUAL CHIP i2s slave
