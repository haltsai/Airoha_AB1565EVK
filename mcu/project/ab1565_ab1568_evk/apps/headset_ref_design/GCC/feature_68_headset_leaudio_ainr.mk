...
MTK_USB_AUDIO_MICROPHONE              = y
AIR_USB_AUDIO_2ND_SPEAKER_ENABLE      = y
MTK_USB_AUDIO_HID_ENABLE              = y
...
# PEQ Switch peq sound mode wrirte nvkey
AIR_PEQ_WRITE_NVKEY_ENABLE          = n
...
AIR_USB_AUDIO_MIX_ENABLE = y
AIR_USB_IN_PORT2_ENABLE = y
AIR_USB_AUDIO_OUT_ENABLE = y
AIR_USB_HID_MEDIA_CTRL_ENABLE = y

MTK_USB_VOICE_ENABLE = y
# usb audio play enable
MTK_USB_AUDIO_PLAYBACK_ENABLE      = y

# use the slide power not power key.
AIR_SLIDE_POWER_KEY_ENABLE = n
...
# Do not enter RTC mode when Line in or USB in.
AIR_APP_SYSTEM_ON_BY_LINE_IN_ENABLE = y

#Voice detachable MIC support
...
# MS TEAMS
TEAMS_LIB = $(strip $(SOURCE_DIR))/middleware/MTK/ms_teams/module.mk
ifeq ($(TEAMS_LIB), $(wildcard $(TEAMS_LIB)))
