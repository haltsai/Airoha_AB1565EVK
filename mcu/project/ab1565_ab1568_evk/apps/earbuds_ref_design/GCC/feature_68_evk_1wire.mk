...
#define LE Audio
BLE_AUDIO_LIB = $(strip $(SOURCE_DIR))/middleware/MTK/bt_leaudio/module.mk
ifeq  ($(BLE_AUDIO_LIB), $(wildcard $(BLE_AUDIO_LIB)))
MTK_LE_AUDIO_ENABLE                             = n
endif
