...
FLASH_SIZE_8M                         = y
LINKER_SCRIPT_FILE                    = ab156x_flash_8m_psap.ld
...
MTK_SMART_CHARGER_1WIRE_9600        = y
...
# share mode
MCSYNC_SHARE_MODULE = $(strip $(SOURCE_DIR))/middleware/MTK/bt_mcsync_share/module.mk
ifeq ($(AIR_MCSYNC_SHARE_ENABLE), y)
ifneq ($(MCSYNC_SHARE_MODULE), $(wildcard $(MCSYNC_SHARE_MODULE)))
AIR_MCSYNC_SHARE_ENABLE = n
endif
else ifeq ($(AIR_MCSYNC_SHARE_ENABLE), )
ifeq ($(MCSYNC_SHARE_MODULE), $(wildcard $(MCSYNC_SHARE_MODULE)))
...
#For in ear detection
MTK_IN_EAR_FEATURE_ENABLE = y

AIR_PMU_CHARGER_PFM_ENABLE = y
