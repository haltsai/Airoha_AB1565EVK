...
KERNEL_SERVICE_SYSLOG_FILES += $(KERNEL_SYSLOG_SERVICE_SRC)/syslog_version_2_variant.c
ifeq ($(AIR_SYSLOG_BUFFER_SIZE_16K_ENABLE), y)
COM_CFLAGS += -DAIR_SYSLOG_BUFFER_SIZE_16K_ENABLE
endif
ifeq ($(AIR_SYSLOG_BUFFER_SIZE_12K_ENABLE), y)
COM_CFLAGS += -DAIR_SYSLOG_BUFFER_SIZE_12K_ENABLE
endif
ifneq ($(PRODUCT_VERSION),3335)
KERNEL_SERVICE_SYSLOG_FILES += $(KERNEL_SYSLOG_SERVICE_SRC)/syslog_dump_buffer_flash.c
endif
else
