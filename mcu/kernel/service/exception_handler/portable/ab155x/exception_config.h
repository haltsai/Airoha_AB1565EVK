...
#define EXCEPTION_CPU_ID_SLAVE0                         1
#define EXCEPTION_CPU_ID_SLAVE1                         2
...
extern void exception_msgid_portable(uint8_t cpu_id, const char *message, uint32_t arg_cnt, ...);
#define EXCEPTION_PRINT_DEFAULT                         log_print_exception_log
#define EXCEPTION_MSGID_DEFAULT                         exception_msgid_portable
