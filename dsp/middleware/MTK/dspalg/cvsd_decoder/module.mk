...
###################################################
CVSD_CODEC_PATH = middleware/MTK/dspalg/cvsd_decoder
...
ifneq ($(MTK_BT_A2DP_CVSD_USE_PIC),y)
    ifeq ($(MTK_BT_HFP_SPE_ALG_V2),y)
	else
         LIBS += $(strip $(LIBDIR2))/cvsd_decoder/$(IC_CONFIG)/libcvsd_wb_nb_v11_for_155x.a
	endif
else
