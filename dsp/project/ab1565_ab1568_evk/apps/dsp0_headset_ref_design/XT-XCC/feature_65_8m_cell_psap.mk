...
LINKER_SCRIPT_FILE                    = dsp0_flash_8m_psap.lcf
...
# audio advanced passthrough feature enable
AIR_ADVANCED_PASSTHROUGH_LIB = $(strip $(ROOTDIR))/prebuilt/middleware/MTK/dspfw/psap/ab156x/libpsap_protected.a
ifeq ($(AIR_ADVANCED_PASSTHROUGH_LIB), $(wildcard $(AIR_ADVANCED_PASSTHROUGH_LIB)))
	AIR_ADVANCED_PASSTHROUGH_ENABLE = y
    AIR_ADVANCED_PASSTHROUGH_CODE = $(strip $(ROOTDIR))/middleware/MTK/psap_protected/port/chip/ab156x/module.mk
...
#ANC User Unaware
AIR_ANC_USER_UNAWARE_CODE = $(strip $(ROOTDIR))/middleware/MTK/dspalg/user_unaware/module.mk
ifeq ($(AIR_ANC_USER_UNAWARE_CODE), $(wildcard $(AIR_ANC_USER_UNAWARE_CODE)))
AIR_ANC_USER_UNAWARE_ENABLE = y
endif

#ANC Environment_Detection
AIR_ANC_ENVIRONMENT_DETECTION_CODE = $(strip $(ROOTDIR))/middleware/MTK/dspalg/env_detect/module.mk
